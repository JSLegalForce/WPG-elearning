...
// ============================================================
// THEMA 1: Noodzakelijkheid & herkomst (Art. 3 lid 1, 2 en 5)
// ============================================================
{
...
},
{
  ...
  opties: [
    ...
    "Het proces-verbaalnummer en de zaakomschrijving",
    "De handtekening van zijn leidinggevende ter goedkeuring",
...
// ============================================================
{
  ...
  opties: [
    "Ze had de politie moeten inschakelen voor verificatie voordat zij iets mocht vastleggen",
    "Er is geen probleem zolang ze de registratie naderhand corrigeert op basis van nieuwe informatie",
    "Ze had een apart vermoedensregister moeten aanleggen naast de reguliere registratie",
...
},
{
  ...
  artikel: "Art. 4 lid 1 Wpg",
  opties: [
    "Dat gegevens worden gedeeld met alle betrokken collega's binnen de organisatie",
    "Dat gegevens juist, volledig en ter zake dienend zijn",
    "Dat gegevens altijd worden geverifieerd door de leidinggevende voor verwerking",
    "Dat gegevens worden opgeslagen in een centraal landelijk systeem"
  ],
  juist: 1,
...
// ============================================================
{
  ...
  opties: [
    ...
    "De rapportage is te beknopt voor een procesdossier en voldoet niet aan de minimumvereisten",
    "De naam van de betrokkene ontbreekt in de rapportage waardoor identificatie niet mogelijk is",
    "Er is geen probleem; dit is een gebruikelijke en toegestane observatiewijze"
  ],
  juist: 0,
...
},
{
  ...
  artikel: "Art. 4 lid 3 Wpg",
  opties: [
    "'Betrokkene gedroeg zich verdacht en leek nerveus tijdens de controle'",
    "'Betrokkene is waarschijnlijk betrokken bij de zaak op grond van het gedrag'",
    "'Betrokkene liep bij het zien van verbalisant snel weg; naar het oordeel van verbalisant was sprake van vluchtgedrag'",
    "'Betrokkene maakte een onbetrouwbare indruk op verbalisant tijdens het gesprek'"
  ],
  juist: 2,
  uitleg: "Artikel 4 lid 3 Wpg verplicht een expliciet onderscheid: de feitelijke waarneming ('liep snel weg') wordt gescheiden van de beoordeling ('naar het oordeel van verbalisant'). De andere opties bevatten oordelen zonder expliciete scheiding van de feitelijke waarneming."
},
...
// ============================================================
{
  ...
  opties: [
    "Dit is toegestaan zolang iedereen een geheimhoudingsverklaring heeft ondertekend",
    "Dit mag tijdelijk als de organisatie structureel onderbezet is en de werkdruk hoog is",
    "Dit is in strijd met de Wpg: autorisaties moeten zijn gebaseerd op functie en taakgebonden noodzaak",
    "Dit is alleen een probleem als de medewerker ook toegang heeft tot artikel 9-gegevens"
  ],
  juist: 2,
...
},
{
  ...
  opties: [
    ...
    "Op de wens van de medewerker zelf en zijn persoonlijke voorkeur",
    "Op het situationele oordeel van de direct leidinggevende per geval",
    "Op het aantal jaren aantoonbare werkervaring binnen de organisatie"
  ],
  juist: 0,
...
// ============================================================
{
  ...
  artikel: "Art. 6b Wpg",
  opties: [
    "Ze had alleen de verdachte mogen registreren; slachtoffers en getuigen vallen buiten het bereik van de Wpg",
    "Ze had alle drie in aparte zaakdossiers met een eigen dossiernummer moeten vastleggen",
    "Er gaat niets mis; alle bij een incident betrokken personen mogen onder dezelfde categorie worden vastgelegd",
...
},
{
  ...
  artikel: "Art. 6b Wpg",
  opties: [
    "Omdat het systeem dan minder opslagruimte gebruikt en sneller werkt",
    ...
    "Omdat dit uitsluitend relevant is bij grootschalige artikel 9-onderzoeken",
    "Omdat de politie anders geen toegang krijgt tot de registratie van de BOA-organisatie"
  ],
  juist: 1,
...
// ============================================================
{
  ...
  artikel: "Art. 7 Wpg",
  opties: [
    "Geen regel, want haar partner werkt ook in het publieke domein en is betrouwbaar",
    "Alleen de AVG, want het gaat om de verwerking van persoonsgegevens van derden",
    "De geheimhoudingsplicht: die geldt ook buiten werktijd tegenover personen zonder taakgebonden toegang",
    "Er is geen overtreding zolang de partner de informatie voor zichzelf houdt en niet doorgeeft"
  ],
  juist: 2,
...
},
{
  ...
  artikel: "Art. 7 Wpg",
  opties: [
    "Alleen voor de verwerkingsverantwoordelijke en direct leidinggevenden",
    "Alleen voor BOA's tijdens hun reguliere werktijd en dienst",
    "Alleen voor gegevens die betrekking hebben op aangehouden verdachten",
...
// ============================================================
{
  ...
  opties: [
    "Nee, want hij legt alleen een waarschuwing op en geen formele boete of proces-verbaal",
    "Ja, want het gaat om een strafbaar feit en Thomas treedt op als opsporingsambtenaar",
    "Nee, want vaarwegregels en overtredingen op het water vallen buiten het bereik van de Wpg",
    "Alleen als er later alsnog een officieel proces-verbaal wordt opgemaakt en ingediend"
  ],
  juist: 1,
...
},
{
  ...
  opties: [
    ...
    "Een grootschalig opsporingsonderzoek naar georganiseerde illegale asbestdumping",
    "Een BOA die een bon uitschrijft voor het verkeerd aanbieden van huishoudelijk afval",
    "Een telefoontap die is toegestaan in het kader van een strafrechtelijk onderzoek"
  ],
  juist: 2,
  uitleg: "Artikel 8 lid 1 Wpg regelt alledaagse opsporingshandelingen zoals het uitschrijven van een bon. De overige opties zijn voorbeelden van artikel 9-verwerkingen vanwege de grotere inbreuk op de persoonlijke levenssfeer en de bijzondere opsporingsbevoegdheden die daarvoor nodig zijn."
},
...
// ============================================================
{
  ...
  opties: [
    "Breed gebruik is nog steeds toegestaan; de brede gebruiksfase loopt tot 5 jaar na vastlegging",
    "De gegevens zijn uitsluitend beschikbaar voor interne audits; operationeel gebruik is al beëindigd",
    "Alleen gericht zoeken is toegestaan; breed gebruik gold uitsluitend in het eerste jaar",
    "De gegevens moeten per direct worden vernietigd omdat de gebruikstermijn is verstreken"
  ],
  juist: 2,
...
},
{
  ...
  opties: [
    ...
    "De gegevens moeten direct worden vernietigd zodra het onderzoeksdoel is bereikt",
    "De gegevens mogen 10 jaar worden bewaard na de formele afsluiting van het onderzoek",
    "De gegevens blijven beschikbaar zolang de zaak maatschappelijk of politiek relevant is"
  ],
  juist: 0,
...
// ============================================================
{
  ...
  opties: [
    "Nee, verstrekking aan private partijen zoals woningbouwverenigingen is te allen tijde verboden",
    "Ja, maar alleen als er een rechtsgeldig convenant is, de verstrekking noodzakelijk is én wordt vastgelegd",
    "Ja, het ondertekende convenant volstaat als grondslag zonder verdere aanvullende voorwaarden",
    "Alleen als de betrokkene zelf schriftelijk toestemming heeft verleend voor de verstrekking"
  ],
  juist: 1,
...
},
{
  ...
  opties: [
    "Als de ontvangende partij er uitdrukkelijk om vraagt en het beoogde doel nuttig lijkt",
    "Als de direct leidinggevende mondeling toestemming verleent voor de verstrekking",
    "Altijd, zolang de verstrekte gegevens volledig zijn geanonimiseerd voor verzending",
...
// ============================================================
{
  ...
  opties: [
    "Er is geen probleem; een verstrekkingsoverzicht is niet verplicht onder de Wpg",
    "De burger heeft geen wettelijk recht te weten met wie zijn gegevens zijn gedeeld",
    "Dit is uitsluitend een probleem bij verstrekkingen van bijzondere artikel 9-gegevens",
...
},
{
  ...
  opties: [
    ...
    "Audits, datalekken, logging en autorisatiebeslissingen van de verwerkingsverantwoordelijke",
    "Verwerkingen, bewaartermijnen, autorisaties en systeemlogging van toegang",
    "Processen-verbaal, opgelegde boetes, waarschuwingen en ingediende inzageverzoeken"
  ],
  juist: 0,
...
// ============================================================
{
  ...
  artikel: "Art. 32a Wpg",
  opties: [
    "De autorisatieverplichting van art. 6 Wpg die toegang op functieniveau reguleert",
    "De loggingsverplichting die alle toegang tot politiegegevens automatisch registreert",
    "De geheimhoudingsplicht van art. 7 Wpg die medewerkers verplicht tot zwijgen",
    "De documentatieplicht van art. 32 Wpg voor verstrekkingen aan derden"
  ],
  juist: 1,
...
},
{
  ...
  opties: [
    ...
    "Het versnellen van zoekopdrachten en het optimaliseren van systeemprestaties",
    "Het automatisch verwijderen van gegevens waarvan de bewaartermijn is verstreken",
    "Het bijhouden van werktijden en productiviteitsgegevens van medewerkers"
  ],
  juist: 0,
...
// ============================================================
{
  ...
  artikel: "Art. 33a Wpg",
  opties: [
    "Niets doen; een onopzettelijke fout kwalificeert juridisch niet als meldplichtig datalek",
    "Het datalek zo snel mogelijk intern melden, ook als het onopzettelijk was",
    "Afwachten of de ontvanger reageert of aangeeft de gegevens te hebben ontvangen",
    "Alleen melden als achteraf vaststaat dat de ontvanger de gegevens daadwerkelijk heeft ingezien"
  ],
  juist: 1,
...
},
{
  ...
  artikel: "Art. 33a Wpg",
  opties: [
    "Binnen 72 uur na ontdekking, gelijk aan de termijn voor melding bij de Autoriteit Persoonsgegevens",
    "Binnen vijf werkdagen na ontdekking van het datalek",
    "Zo snel mogelijk, uiterlijk binnen 24 uur na ontdekking",
    "Binnen 48 uur na ontdekking van het datalek"
  ],
  juist: 2,
